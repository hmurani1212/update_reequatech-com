...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:5040/api/send_email", formData, {
        headers: {
      ...
      if (response.status === 200) {
        ...
        toast.error("Failed to send the message."); // Toast error message
      }
    } catch (error) {
      ...
      if (error.response && error.response.data && error.response.data.MESSAGE) {
        ...
        toast.error("Error: Could not send the message. Try again later.");
      }
    }
  };
        ...
        <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
          ...
          <div className="bg-gray-100 p-6 rounded-lg">
            <p className="text-sm font-semibold text-gray-800 text-center">
              <button
                type="button"
                className="px-4 py-2 rounded-lg bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079]"
              >
                Contact with Us
              </button>
            </p>
            ...
            <form className="mt-8 space-y-4">
              ...
              <input
                type="text"
                placeholder="Please enter subject" value={subject} onChange={(e) => setsubject(e.target.value)}
                className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]"
              />
              <textarea
              ...
              >
                ...
                <input id="photo-dropbox" onChange={(e) => setfile(e.target.files[0])} type="file" className="sr-only" />
              </label>
